    ...
    $('#Next-ToBuildingSelection').on('click', function () {
        ...
        $('#Next-ToModuleSelection').hide();
            ...
            $('#Next-ToBucketSelection').on('click', function () {
                ...
                //selection = $('#stationtypesresultset tr.highlight td').filter('#selectedModuleName').html()

                selection = selectedFFInstanceID;

                var result = '';

                $.getJSON('/FFSite/GetDropDownData', { typeofData: "StationTypesList", filterID: selection }, function (data) {
                    ...
                    $.each(data, function (i, stationtype) {
                        ...
                        result += '<tr style="width:50%;"><td id="selectedStationTypeName" style="border-radius:15px;font-weight: bold">' + stationtype.StationTypeName + '</td><td id="selectedStationTypeID" style="display:none;">' + stationtype.id + '</tr>';
                    });
                    ...
                    * that includes headers. */
                    var row = '';
                    var selectedFFInstanceID = '';
                    var rows = $('#stationtypesresultset tr');
                    ...
                    rows.on('click', function (e) {
                        ...
                        /*Reset field values*/
                        $('#stationtypesresultset tr.highlight').removeClass('highlight');
                        selectedFFInstanceID = '';
                        ...
                        if (!state) {
                            ...
                            $("#progressbar li").eq(4).append("<br/> { " + row.find('td').eq(0).html() + " }");
